    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-civic-border">
      <div className="max-w-7xl mx-auto pl-3 pr-4 h-14 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-sm tracking-widest uppercase text-civic-text">Proba<span className="text-civic-accent">Estado</span></span>
        </Link>
        <div className="flex items-center gap-4 text-sm font-medium">
          ...
          <Link to="/institucional" className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-xs font-semibold transition-all ${loc.pathname === "/institucional" ? "bg-civic-green/20 border-civic-green text-civic-green" : "border-civic-green/30 text-civic-green hover:bg-civic-green/10"}`}><Building2 size={12} />Institucional</Link>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link to="/login" className="flex items-center gap-1.5 px-3 py-1.5 bg-civic-accent/10 border border-civic-accent/40 text-civic-accent rounded-lg text-xs font-semibold hover:bg-civic-accent/20 transition-all"><LogIn size={12} />Conectar</Link>
        </div>
      </div>
    </nav>
  );
